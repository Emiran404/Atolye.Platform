...
<!-- CORE BADGES -->
[![Version](https://img.shields.io/badge/Versiyon-4.4.2-6366f1?style=for-the-badge)](https://github.com/Emiran404/Atolye.Platform/releases)
...
> [!IMPORTANT]
> **🎉 v4.3.3 İle Gelen Dev Yenilikler**
...
- [x] ~~Sistem Konsolu ve Canlı Log İzleme (v4.3.3)~~
- [x] ~~Çoklu Cihaz Passkey Desteği (v4.3.3)~~
- [x] ~~Auto-Reconnect ve Hızlı Hata Kurtarma (v4.3.3)~~
